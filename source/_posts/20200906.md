...
##### 1.题目
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620092.png)

##### 2.解题步骤
发现框框...应该是注入题...源码中提示有个waf，继续看源码，发现有个calc.php，进去看看
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620093.png)
初步理解应该是用num传参，然后返回计算结果，这个php文件用于过滤非法字符。
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620094.png)
被拦下来了，大概是利用num构造一个payload，不能含有字母和非法字符，只能有数字和符号
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620095.png)
这里已经不会了，看writeup吧...
先贴效果
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620096.png)

![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620097.png)
...
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620098.png)
很遗憾被过滤了，使用ascii码绕过
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620099.png)
查看根目录下文件，发现有f1agg，使用file_get_contents()访问。这次不浪费时间，同样使用ascii码绕过
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234620100.png)
