...
### I^2^C总线典型接法
![IIC总线结构图](https://i-blog.csdnimg.cn/blog_migrate/350cdab590aacbbbd2c06bb6895ab1d7.png)
...
一次I^2^C总线通信的流程大致可分为：
 ...
 5. 接收应答信号
 6. 发送结束信号
![IIC总线通信格式](https://i-blog.csdnimg.cn/blog_migrate/439c9f1bfd1e4dbec87a8c80b4d9cd57.png)
...
![IIC总线有效性规定](https://i-blog.csdnimg.cn/blog_migrate/0f4c9cbe5483ae7a8e11c3590811c3e6.png)
![应答信号](https://i-blog.csdnimg.cn/blog_migrate/d7e296d74d7737e41512cd90ef5fc007.png)
...
```
##### 4. 结束信号
![IIC结束信号](https://i-blog.csdnimg.cn/blog_migrate/ccd4c147ecf65dfd26dd7eb56d1647dd.png)
...
##### 1.AT24C02引脚图
![AT24C02引脚图](https://i-blog.csdnimg.cn/blog_migrate/da231551222741636bfaa1a888c82cb1.png)
...
![IIC字节写入模式](https://i-blog.csdnimg.cn/blog_migrate/bafe790595db0afb99eac77387d1c7b1.png)
```c
IIC_Start();//发送起始信号
...
![IIC页写入模式](https://i-blog.csdnimg.cn/blog_migrate/c755c86c447f3f091f7326e43c55d2d0.png)
```c
IIC_Start();//发送起始信号
IIC_WriteByte(0xA0);//发送寻址信号 
IIC_WriteByte(addr);//发送需要写入的片内地址
...
![IIC字节读取模式](https://i-blog.csdnimg.cn/blog_migrate/f7d9e7bbeaec2b29c965c67828da0756.png)
```c
IIC_Start();		//发送起始信号
...
![IIC页读取模式](https://i-blog.csdnimg.cn/blog_migrate/574acf3b539fcee15ffc1ca9520cd233.png)
```c
IIC_Start();		//发送起始信号
IIC_WriteByte(0xA0);//发送写命令
IIC_WriteByte(addr);//发送需要写入的片内地址
