...
##  一、[极客大挑战 2019]PHP
##### 1.题目
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814531.png)
题目是一只可爱的猫猫
##### 2.解题步骤
提示备份，因此访问一下index.php~
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814532.png)
失败力，访问一下bak呢
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814533.png)
换个思路 访问一下flag.php
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814534.png)
竟然没有拒绝访问，看来是有这个文件，继续访问flag的备份试试

![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814535.png)
是我年轻了...看writeup吧~ 
提示要字典爆破目录...这里先直接抄近路了，以后要学习一下字典爆破目录，直接访问www.zip
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814536.png)
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814537.png)
flag.php
...
?>
```
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814538.png)
...
得到flag
![在这里插入图片描述](https://qiniu.mingxuan.xin/picgo/20260302234814539.png)
